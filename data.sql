...
-- Started on 2020-07-22 11:09:25
...
--
-- TOC entry 2831 (class 0 OID 16421)
-- Dependencies: 203
-- Data for Name: files; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.files (uuid, name, type, duration, size, user_id) FROM stdin;
867c2226-2433-4681-b125-1f83e6801e06	first file	mp4	100000	200000	\N
273dcc39-454c-4fa1-a1e0-2e6ae0978a63	another file	wav	50000	1234500	\N
e25613ff-a115-4a07-b809-9cc095c6c505	third file	mp4	345654	20000	\N
644727e3-abac-4ea7-a889-3141979b40f3	yet another file	wav	8848484	34343	\N
1d9e697c-9059-4544-ba46-ef698ea2ee1c	last file	mp4	1000	2500	\N
\.
...
COPY public.users (uuid, name, country_id) FROM stdin;
...
--
-- TOC entry 2701 (class 2606 OID 16438)
...
--
-- TOC entry 2702 (class 2606 OID 16439)
...
ALTER TABLE ONLY public.files
    ADD CONSTRAINT "FK_user_id" FOREIGN KEY (user_id) REFERENCES public.users(uuid) ON DELETE RESTRICT NOT VALID;


-- Completed on 2020-07-22 11:09:25
